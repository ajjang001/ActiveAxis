...
import UserFitnessPlanDetailsPage2 from './src/view/user/UserFitnessPlanDetailsPage2';
...
import UserDetailsPage from './src/view/user/UserDetailsPage';
...
//this function is to keep the bottom tab for competition pages
  ...
  <Stack.Navigator>
      ...
      <Stack.Screen name="CompetitionLeaderboardPage" component={CompetitionLeaderboardPage} options={{ title: 'Back', headerStyle: { backgroundColor: '#FBF5F3' }, ...TransitionPresets.SlideFromRightIOS }}/>
  ...
  return (
      <NavigationContainer>
        <Stack.Navigator initialRouteName="LoginPage">
          ...
          <Stack.Screen name="UserDetailsPage" component={UserDetailsPage} options={{ title: 'Back', headerStyle: { backgroundColor: '#FBF5F3' }, ...TransitionPresets.SlideFromRightIOS }} />                         
