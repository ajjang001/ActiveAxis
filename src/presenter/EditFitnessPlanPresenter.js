...
class EditFitnessPlanPresenter{
    ...
    async saveFitnessPlan (coach, photo, goalType, description, name, medicalCheck, routines){
        
        try{
            if (goalType === 0 || goalType === undefined){
                ...
                console.log('going fitness plan model update');
                await this.model.updateFitnessPlan(coach, photo, goalType, description, name, medicalCheck, routines);
                console.log('fitness plan model updated');
